  ...
  <body>
    ...
    ?>
      ...
      <div class="row align-items-center">
        <div class="col-md-9">
          <h4 class="text-light text-uppercase mb-0">Feedback</h4>
        </div>
        <div class="col-md-3">
          <ul class="navbar-nav">
                ...
                <table class="table table-bordered table-list" style="box-shadow: 5px 7px 25px #999;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      ?>
                      <td><a class="btn btn-warning" href ="feedbackdetail.php?id=<?php echo $row['id'];?>"><?php echo $row['Email'];?></a></td>
                    ...
                    <?php
                        ...
                        echo "<tr><td class='text-center' colspan='7' >No feedback yet </td></tr>";
                      }
                    ?>
                  </tbody>
                </table>        
              ...
              <div class="panel-footer">
                <div class="row">
                  ...
                  <ul class="pagination hidden-xs pull-right">  
                      ...
                      ?>
                      <li class="page-item"><a class="page-link" href="viewfeedback.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li> 
                      <?php  
                        }
                      ?>                
                    </ul>
