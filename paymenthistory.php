...
<html>
  ...
  <head>
      <title>FoodTiger - Payment History</title>
              ...
              <div class="panel panel-default panel-table">
                <div class="panel-body">
                  <table class="table">
                    ...
                    ?>
                    <tr>
                      <td><a href ="orderdetail.php?order_id=<?php echo $order_id;?>"><button type="button" class="btn btn-warning" ><?php echo $row['order_id'];?></button></a></td>
