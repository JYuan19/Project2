    ...
    <body>
        ...
        <div class="col-lg-9 col-xl-10 col-md-8 ml-auto fixed-top py-2 top-navbar" style="background-color: #ffbf55;">
            <div class="row align-items-center">
                <div class="col-md-9">
                <h4 class="text-light text-uppercase mb-0">Chat List</h4>
                </div>
                <div class="col-md-3">
                <ul class="navbar-nav">
                            ...
                            <table class="table table-bordered table-list" style="box-shadow: 5px 7px 25px #999;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <a class="btn btn-info" href="adminChat.php?Email=<?php echo $row['Email']; ?>"><spanclass="new badge"><em class="fa fa-commenting"></em></span></a>
                                        </td>
                                    </tr>
                                        <?php
                                            }
                            ...
                            <div class="row">
                                ...
                                <div class="col col-xs-8">
                                    <ul class="pagination hidden-xs pull-right">  
                                        ...
                                        ?>
                                        <li class="page-item"><a class="page-link" href="viewChatList.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li> 
                                        <?php  
                                            }
                                        ?>                
                                    </ul>
