...
<html>
  ...
  <body>
    <?php
      ...
      $sql="select * from returnorder where statusreturn='pending'  LIMIT ".$page1.", 6";
      $result=$conn->query($sql); 
    ?>
		<div class="col-lg-9 col-xl-10 col-md-8 ml-auto fixed-top py-2 top-navbar" style="background-color: #ffbf55;">
      <div class="row align-items-center">
        <div class="col-md-9">
          <h4 class="text-light text-uppercase mb-0">Request Return Order List</h4>
        </div>
        <div class="col-md-3">
          <ul class="navbar-nav">
            ...
            <div class="panel-heading">
              <div class="row">
                <div class="col col-xs-6">
                  <h3 class="panel-title">Request Return Order List</h3>
                </div>
                ...
                <?php
                  if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) { 
					      ?> 
                <tr>
                  <td><a class="btn btn-warning" href ="returnorderdetail.php?id=<?php echo $row['id'];?>"><?php echo $row['order_id'];?></a></td>
                  <td><?php echo $row['name'];?></td>
                  <td><?php echo $row['reason'];?></td>
                  <td><?php echo $row['image'];?></td>
                  <td><?php echo $row['statusreturn'];?></td>
                </tr>
                <?php
                    } 
                  } 
          ...
          <div class="panel-footer">
            <div class="row">
              ...
              <div class="col col-xs-8">
                <?php
                  $result = $conn->query("SELECT * FROM returnorder where statusreturn = 'pending'");
