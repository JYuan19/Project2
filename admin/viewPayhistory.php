  ...
  <body>
    ...
    ?>
      ...
      <div class="row align-items-center">
        <div class="col-md-9">
          <h4 class="text-light text-uppercase mb-0">Payment List</h4>
        </div>
        <div class="col-md-3">
          <ul class="navbar-nav">
              ...
              <div class="row">
                ...
                <div class="col col-xs-8">
                  <ul class="pagination hidden-xs pull-right">  
                    ...
                    ?>
                    <li class="page-item"><a class="page-link" href="viewPayhistory.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li> 
                    <?php  
                      }
                    ?>                
                  </ul>
