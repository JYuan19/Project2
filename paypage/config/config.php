...
define('PAYPAL_RETURN_URL', 'http://localhost/Project2/paypage/paypal/success.php');
define('PAYPAL_CANCEL_URL', 'http://localhost/Project2/paypage/paypal/cancel.php');
define('PAYPAL_CURRENCY', 'MYR'); // set your currency here
 
// Connect with the database 
$db = new mysqli('localhost', 'root', '', 'foodtiger'); 
